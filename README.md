...
<li><b><a href="https://github.com/Shivam06/OpenCV/blob/master/Sudoku/Scripts/KNearestNeighbour.py">KNearestNeighbour.py</a></b> - Module containing KNN class which has been used in <b>main.py</b> to check the accuracy over test set after training the knn model over training data.</li>
